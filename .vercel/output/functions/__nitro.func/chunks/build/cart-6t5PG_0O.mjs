...
const o = defineStore("cart", { state: () => ({ items: [], loading: false, error: null }), getters: { totalItems: (t) => t.items.reduce((e, i) => e + i.quantity, 0), totalPrice: (t) => t.items.reduce((e, i) => e + i.price * i.quantity, 0) }, actions: { addItem(t) {
...
export { o };
//# sourceMappingURL=cart-6t5PG_0O.mjs.map
