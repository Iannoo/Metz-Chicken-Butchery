...
const c = defineComponent({ __name: "index", __ssrInlineRender: true, setup(l) {
  const t = o();
  i(), Q();
...
c.setup = (l, t) => {
  ...
  return (a.modules || (a.modules = /* @__PURE__ */ new Set())).add("pages/order/checkout/index.vue"), n ? n(l, t) : void 0;
};

export { c as default };
//# sourceMappingURL=index-CjyCezyf.mjs.map
