...
import { p as parseQuery, h as hasProtocol, k as joinURL, x as withTrailingSlash, y as withoutTrailingSlash } from '../_/nitro.mjs';
import { u as J, b as h$1, c as Z, r as bt, n as wt, d as vo } from './server.mjs';
...
function F(n) {
  ...
  function q(e) {
    var _a, _b, _c;
    const r = J(), d = Z(), u = computed(() => !!e.target && e.target !== "_self"), f = computed(() => {
      const a = e.to || e.href || "";
      ...
      if (v.value) {
        const h = typeof t.value == "object" && "path" in t.value ? bt(t.value) : t.value, i = typeof h == "object" ? r.resolve(h).href : h;
        return x(i, a);
      }
    ...
    return { to: t, hasTarget: u, isAbsoluteUrl: f, isExternal: v, href: y, isActive: (_a = l == null ? void 0 : l.isActive) != null ? _a : computed(() => t.value === r.currentRoute.value.path), isExactActive: (_b = l == null ? void 0 : l.isExactActive) != null ? _b : computed(() => t.value === r.currentRoute.value.path), route: (_c = l == null ? void 0 : l.route) != null ? _c : computed(() => r.resolve(t.value)), async navigate(a) {
      await wt(y.value, { replace: e.replace, external: v.value || u.value });
    } };
  }
