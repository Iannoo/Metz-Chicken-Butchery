...
import { n } from './cart2.mjs';
import { i } from './useAuth.mjs';
...
p.setup = (n, s) => {
  ...
  return (i.modules || (i.modules = /* @__PURE__ */ new Set())).add("pages/cart/index.vue"), c ? c(n, s) : void 0;
};
