...
import { b as buildAssetsURL, a as useRuntimeConfig, d as defineRenderHandler, c as publicAssetsURL, g as getQuery, e as createError, f as getRouteRules, u as useNitroApp, h as getResponseStatusText, i as getResponseStatus } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Premium free-range chicken from Metz Chicken Butchery"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Metz Chicken Butchery"};
