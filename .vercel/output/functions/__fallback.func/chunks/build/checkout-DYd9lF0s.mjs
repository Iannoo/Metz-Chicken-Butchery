...
c.setup = (l, t) => {
  ...
  return (a.modules || (a.modules = /* @__PURE__ */ new Set())).add("pages/order/checkout.vue"), n ? n(l, t) : void 0;
};

export { c as default };
//# sourceMappingURL=checkout-DYd9lF0s.mjs.map
