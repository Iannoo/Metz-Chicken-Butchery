...
const x = defineComponent({ __name: "register", __ssrInlineRender: true, setup(i$1) {
  i(), q();
  const a = ref(""), t = ref(""), m = ref(""), n = ref(""), l = ref(""), d = ref(false), u = ref(null), y = computed(() => a.value && t.value && m.value && n.value && l.value && n.value === l.value);
  return (S, o, b, v) => {
    const g = J;
...
export { x as default };
//# sourceMappingURL=register-DMTZn0aD.mjs.map
